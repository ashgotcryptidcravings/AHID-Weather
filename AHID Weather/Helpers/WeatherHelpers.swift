...
enum WeatherCode {
    ...
    static let sfSymbols: [Int: String] = [
        0: "sun.max.fill", 1: "sun.min.fill", 2: "cloud.sun.fill", 3: "cloud.fill",
        ...
        71: "cloud.snow.fill", 73: "cloud.snow.fill", 75: "snowflake", 77: "snowflake",
        80: "cloud.rain.fill", 81: "cloud.rain.fill", 82: "cloud.bolt.rain.fill",
        85: "cloud.snow.fill", 86: "snowflake",
    ...
    static func sfSymbol(for code: Int) -> String {
        sfSymbols[code] ?? "thermometer.medium"
    }
}

// MARK: - Unit Conversions
enum WeatherUnits {
    static func tempUnit(_ useCelsius: Bool) -> String {
        useCelsius ? "\u{00B0}C" : "\u{00B0}F"
    }
...
// MARK: - Theme Colors
struct ThemeColors {
    static let void0 = Color(red: 0.031, green: 0.031, blue: 0.031)       // #080808
    static let void2 = Color(red: 0.059, green: 0.059, blue: 0.059)       // #0f0f0f
    static let void3 = Color(red: 0.086, green: 0.086, blue: 0.086)       // #161616
    static let void4 = Color(red: 0.118, green: 0.118, blue: 0.118)       // #1e1e1e
    static let accent = Color(red: 0.486, green: 0.227, blue: 0.929)      // #7c3aed
    static let accentBright = Color(red: 0.659, green: 0.333, blue: 0.969) // #a855f7
    static let accentDim = Color(red: 0.486, green: 0.227, blue: 0.929).opacity(0.15)
    static let white = Color(red: 0.941, green: 0.941, blue: 0.941)       // #f0f0f0
    ...
    static let panelBorderHover = Color(red: 0.486, green: 0.227, blue: 0.929).opacity(0.35)
}
